    ...
    <div class="container mt-3">
        <div class="card mt-2">
            <div class="card-body">
                ...
                <p>
                    <span class="fw-bold">Нормальные алгоритмы Маркова</span> — это математическая модель вычислений,
                    разработанная советским математиком Андреем Андреевичем Марковым в 1950-х годах. Они представляют
                    собой один из формальных методов для определения алгоритмов. Основная идея заключается в применении
                    последовательности подстановочных правил для преобразования строк символов.
                    Принципы работы нормального алгоритма Маркова:
                </p>

                <ul>
                    <li>
                        <span class="fw-bold">Строка данных</span> — это последовательность символов из некоторого
                        алфавита.
                    </li>
                    <li>
                        <span class="fw-bold">Правила подстановки</span> задают, как изменять строку. Они состоят из двух
                        частей: слева — подстрока,
                        которую
                        нужно найти, справа — подстрока, на которую нужно заменить найденную.
                    </li>
                    <li>
                        <span class="fw-bold">Последовательное применение правил</span>: алгоритм идет по строке слева
                        направо и проверяет, можно ли
                        применить одно из правил. Если можно — применяется первое подходящее правило.
                    </li>
                    <li>
                        <span class="fw-bold">Конечное условие</span>: некоторые правила могут быть помечены как
                        конечные, и
                        если такое правило
                        применяется,
                    ...
                    <li>
                        <span class="fw-bold">Однозначность и детерминированность</span>: правила применяются в строгом
                        порядке, и как только одно
                        правило
                        успешно применяется, остальные правила на текущем шаге игнорируются.
                    </li>
                </ul>
